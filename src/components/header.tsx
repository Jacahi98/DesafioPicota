...
export function Header() {
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-[var(--paper)]/90 backdrop-blur">
      <div className="mx-auto grid max-w-6xl grid-cols-[1fr_auto_1fr] items-center gap-3 px-4 py-3 sm:px-8">
        <span aria-hidden="true" />
        <Link href="/#top" className="flex min-w-0 shrink-0 items-center justify-self-center">
